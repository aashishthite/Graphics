...
Shader::Shader()
{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	this->light_id_handle = BAD_GL_VALUE;
	this->copy_modelview_handle=BAD_GL_VALUE;
	this->reflectance_handle=BAD_GL_VALUE;
	this->special_effect_handle=BAD_GL_VALUE;
	this->after_effect_handle=BAD_GL_VALUE;
	/////////////////////////////////////////////////////////////////////////////////////////////////
	this->special_effect = 0;
}
...
*/
void Shader::switch_special_effect(void)
{
	this->special_effect += 1;
	if(this->special_effect == 4)
	{
		this->special_effect = 0;
	}
}

void Shader::CommonSetup(const float time, const GLint * size, const GLfloat * projection, const GLfloat * modelview, const GLfloat * mvp, const GLfloat * nm, const glm::vec3 reflect)
{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	glUniform1i(this->light_id_handle,light_id);
	glUniformMatrix4fv(this->copy_modelview_handle, 1, GL_FALSE, glm::value_ptr(copy_modelview));
	glUniform3f(this->reflectance_handle, reflect.x, reflect.y, reflect.z);
	glUniform1i(this->special_effect_handle,this->special_effect);
	glUniform1i(this->after_effect_handle,after_effect);
	/////////////////////////////////////////////////////////////////////////////////////////////////
}

void Shader::Use()
{
	if((this->program_id == BAD_GL_VALUE))
	{
...
bool Shader::Initialize(char * vertex_shader_file, char * fragment_shader_file)
{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////
	this->light_id_handle=glGetUniformLocation(this->program_id, (const GLchar *) "light_id");
	this->copy_modelview_handle=glGetUniformLocation(this->program_id,(const GLchar *) "camera_matrix");
	this->reflectance_handle=glGetUniformLocation(this->program_id,(const GLchar *) "reflectance");
	this->after_effect_handle=glGetUniformLocation(this->program_id,(const GLchar *) "after_effect");
	this->special_effect_handle=glGetUniformLocation(this->program_id,(const GLchar *) "special_effect");
	/////////////////////////////////////////////////////////////////////////////////////////////////
	glUseProgram(0);
...
void Shader::CustomSetup(GLfloat Wcrop, const GLfloat Hcrop, const glm::vec2 striker_coord)
{
}
