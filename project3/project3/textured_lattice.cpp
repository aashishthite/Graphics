...
bool textured_lattice::Initialize(int slices, const char* texture_file, FrameBufferObject* fbo)
{
...
bool textured_lattice::Draw(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, const GLfloat Wcrop, const GLfloat Hcrop, GLint fbo_attachment, const glm::vec2 striker_coord)
{
	...
	{
		glBindTexture(GL_TEXTURE_2D, myfbo->texture_handles[fbo_attachment]);
		///////////////////////////////////////////////////
	...
	this->current_shader->CustomSetup(Wcrop, Hcrop,striker_coord);
	//phong_shader.Use();
