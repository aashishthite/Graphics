...
class stool
{
	private:
		...
		bool DrawBase(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);
		bool DrawBase_leg(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);
		bool DrawBase_plancks(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);
		bool DrawBase_tube(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);
		bool DrawBase_ring(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);

		bool DrawSeat(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, bool adjust_height, bool highlight_seat);
		bool DrawSeat_planck(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, bool adjust_height, bool highlight_seat);
		bool DrawSeat_connector(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);
		bool DrawSeat_stem(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);
		bool DrawSeat_thread(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size);
