...
void stool::Draw(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, GLfloat pos_x, GLfloat pos_y, GLfloat pos_z, GLfloat rot_y, GLfloat seat_height, bool adjust_height, bool highlight_seat)
{
	...
	DrawBase(projection, local_modelview, size);
	...
	DrawSeat(projection, local_modelview, size, adjust_height, highlight_seat);
}

void stool::DrawBase(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	glm::mat4 local_modelview = modelview;
	...
	DrawBase_leg(projection, local_modelview, size);
	...
	DrawBase_plancks(projection, local_modelview, size);

	////////////////////////////////////////////////////////////////////////////
	//STEP3: Tube connecting the two planks
	DrawBase_tube(projection, local_modelview, size);
	
	////////////////////////////////////////////////////////////////////////////
	//STEP4: The ring connecting the legs near the bottom
	DrawBase_ring(projection, local_modelview, size);
}

void stool::DrawSeat(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, bool adjust_height, bool highlight_seat)
{
	glm::mat4 local_modelview = modelview;
	...
	*/
	...
	DrawSeat_planck(projection, local_modelview, size, adjust_height, highlight_seat);
	...
	DrawSeat_connector(projection, local_modelview, size);

	////////////////////////////////////////////////////////////////////////////
	//STEP4: Draw the stem
	DrawSeat_stem(projection, local_modelview, size);

	////////////////////////////////////////////////////////////////////////////
	//STEP5: Draw the thread on the stem
	DrawSeat_thread(projection, local_modelview, size);
}

void stool::DrawBase_leg(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	glm::mat4 local_modelview = modelview;
	...
	stoolBase.cube_leg->Draw(projection, local_modelview, size);
}

void stool::DrawBase_plancks(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	glm::mat4 local_modelview = modelview;
	...
	stoolBase.planck1_cylinder_out->Draw(projection, local_modelview, size);
	stoolBase.planck1_cylinder_in->Draw(projection, local_modelview, size);
	stoolBase.planck1_disk_bottom->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.1f));
	stoolBase.planck1_disk_top->Draw(projection, local_modelview, size);
	...
	stoolBase.planck2_cylinder_out->Draw(projection, local_modelview, size);
	stoolBase.planck2_cylinder_in->Draw(projection, local_modelview, size);
	stoolBase.planck2_disk_bottom->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.1f));
	stoolBase.planck2_disk_top->Draw(projection, local_modelview, size);
}

void stool::DrawBase_tube(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	glm::mat4 local_modelview = modelview;
	...
	stoolBase.tube_cylinder_in->Draw(projection, local_modelview, size);
	stoolBase.tube_cylinder_mid->Draw(projection, local_modelview, size);
	stoolBase.tube_disk_low->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.40f));
	stoolBase.tube_cylinder_out->Draw(projection, local_modelview, size);
	stoolBase.tube_disk_mid->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.02f));
	stoolBase.tube_disk_high->Draw(projection, local_modelview, size);
}

void stool::DrawBase_ring(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	glm::mat4 local_modelview = modelview;
	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.5f, 0.0f));
	stoolBase.base_tuboid->Draw(projection, local_modelview, size);
}

void stool::DrawSeat_planck(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, bool adjust_height, bool highlight_seat)
{
	cylinder* regular;
	cylinder* tapered;
	disk* top;
	...
	glm::mat4 local_modelview = modelview;
	regular->Draw(projection, local_modelview, size);
	top->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.04f));
	tapered->Draw(projection, local_modelview, size);
	...
	if(adjust_height)
	{
		...
		this->stoolSeat.square_stool_selected->Draw(projection, local_modelview, size);
	}
}

void stool::DrawSeat_connector(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	...
	stoolSeat.connector1_cylinder->Draw(projection, local_modelview, size);
	stoolSeat.connector1_disk_top->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.01f));
	stoolSeat.connector1_disk_bottom->Draw(projection, local_modelview, size);

	stoolSeat.connector2_cylinder_in->Draw(projection, local_modelview, size);
	stoolSeat.connector2_cylinder_out->Draw(projection, local_modelview, size);
	stoolSeat.connector2_disk_top->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.03f));
	stoolSeat.connector2_disk_bottom->Draw(projection, local_modelview, size);
}

void stool::DrawSeat_stem(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	//The stem is composed of one thicker cylinders at the connector, followed by a long narrow cylinder forming the stem
	glm::mat4 local_modelview = modelview;

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.12f));
	stoolSeat.stem_cylinder_out->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.015f));
	stoolSeat.stem_cylinder_in->Draw(projection, local_modelview, size);
	stoolSeat.stem_disk_top->Draw(projection, local_modelview, size);

	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 1.2f));
	stoolSeat.stem_disk_bottom->Draw(projection, local_modelview, size);
}

void stool::DrawSeat_thread(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size)
{
	glm::mat4 local_modelview = modelview;
	local_modelview = glm::translate(local_modelview, glm::vec3(0.0f, 0.0f, 0.2f));
	stoolSeat.thread_top_helix->Draw(projection, local_modelview, size);
	stoolSeat.thread_bottom_helix->Draw(projection, local_modelview, size);
