...
void tree::Draw(const glm::mat4 & projection, glm::mat4 modelview, const glm::ivec2 & size, GLfloat pos_x, GLfloat pos_y, GLfloat pos_z, GLfloat height)
{
	...
	leaves->Draw(projection, local_modelview, size);
}
...
{
	return this->leaves->Initialize(slices *6);
}
